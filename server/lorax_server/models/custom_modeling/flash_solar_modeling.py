...
class SolarAttention(torch.nn.Module):
    def __init__(
        self,
        prefix: str,
        config,
...
class SolarLayer(nn.Module):
    def __init__(self, prefix, layer_id, config, weights):
        ...
        self.mlp = SolarMLP(prefix=f"{prefix}.mlp", config=config, weights=weights, layer_id=layer_id)

        self.input_layernorm = SolarRMSNorm(
