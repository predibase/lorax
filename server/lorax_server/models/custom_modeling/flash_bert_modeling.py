...
# NOTE: This implementation of flashbert currently isn't working for NER models. Therefore for 
# Bert based NER models we are using the transformers library implementation of BertForTokenClassification
# TODO: (magdy) fix this asap
...
class BertEmbeddings:
    ...
    def forward(self, input_ids, token_type_ids, position_ids):
        ...
        embeds = inputs_embeds + token_type_embeds + position_embeds

        embeddings, _ = self.layer_norm.forward(embeds)
        return embeddings
