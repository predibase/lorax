...
def paged_attention(
    ...
    use_v1 = max_s <= 8192 and (max_num_partitions == 1 or num_seqs * num_heads > 512) and not use_custom
    if use_v1:
...
if ENGINE != "triton":
    try:
        ...
        if major >= 8:
            ...
            raise ImportError(f"AMD GPU with ROCm capability {major} {minor} is not supported") from e
