...
# Copy build artifacts from aqlm kernels builder
COPY --from=aqlm-kernels-builder /usr/src/build/lib.linux-x86_64-cpython-310 /opt/conda/lib/python3.10/site-packages
