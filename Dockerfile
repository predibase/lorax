...
FROM nvcr.io/nvidia/pytorch:24.02-py3 as pytorch-install
...
COPY --from=vllm-builder /usr/src/vllm/build/lib.linux-x86_64-cpython-310 /usr/local/lib/python3.10/dist-packages
